...
invisible(mapply(
    ...
    FUN = function(object, results) {
        markdownHeader(results, level = 2L, tabset = TRUE)
        markdownHeader("shrunken", level = 3L)
        print(plotMA(object, results = results, lfcShrink = TRUE))
        markdownHeader("unshrunken", level = 3L)
        print(plotMA(object, results = results, lfcShrink = FALSE))
    },
    SIMPLIFY = FALSE,
    USE.NAMES = TRUE
))
...
invisible(mapply(
    ...
    FUN = function(object, results) {
        ...
        markdownHeader("shrunken", level = 3L)
        print(plotVolcano(object, results = results, lfcShrink = FALSE))
    },
    SIMPLIFY = FALSE,
    USE.NAMES = TRUE
))
