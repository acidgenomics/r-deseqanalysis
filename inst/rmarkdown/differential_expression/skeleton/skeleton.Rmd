...
params:
  ...
  # DESeqAnalysis object file on disk.
  # Either RDS or RDA file format is supported.
  object: "data/YYYY-MM-DD/object.rds"
  # Uncomment these when looping multiple objects using `render()`.
  # object: !r object
  # name: "object_name"
